...
### Текущий статус
- **Всего уроков пройдено**: 4 (1 в 7 классе, 3 в 8 классе)
- **Прогресс по программе**: 6% (7 класс: 1/30, 8 класс: 3/37)
- **Средний уровень mastery**: 75%

### Текущая оценка знаний
**Прогресс по темам:**
- **7 класс**: 
  - Физические явления, измерения - 75% (Урок 1: Что изучает физика - усвоено хорошо)
  - Механическое движение, силы - 0% (предстоит изучить)
  - Давление, работа, энергия - 0% (предстоит изучить)
- **8 класс**: 
  - Удельная теплоемкость - 75% (Урок 1: освоена формула Q = cmΔt, базовые задачи)
  - Решение задач на количество теплоты - 75% (Урок 2: освоены алгоритмы, уравнение теплового баланса)
  - Теплопередача - 75% (Урок 3: освоены три способа теплопередачи)
  - Горение и удельная теплота сгорания - в процессе (Урок 4: текущий)
  - Плавление, испарение, кипение - 0% (предстоит изучить)
  - Электричество - 0% (предстоит изучить)
- **9 класс**: Механика, колебания, оптика - 0%

### Слабые области
- **Пока не выявлены** - первый урок, требуется больше времени для оценки
- **Требуют внимания**: различие между физическим телом и веществом (может путаться)

### Сильные области  
- **Хорошо понимает**: основные виды физических явлений (механические, тепловые, электрические и т.д.)
- **Интересуется**: практическими примерами и опытами
...
### Важные правила для домашних заданий:
- **НЕ включайте решения и ответы** в домашние задания
- Домашнее задание должно содержать только:
  - Условия задач
  - Подсказки (если необходимо) с формулами и справочными данными
